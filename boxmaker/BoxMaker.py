...
class BoxMaker(inkex.Effect):
    ...
    def effect(self):
        ...
        # generate and draw each piece of the box
        for idx, piece in enumerate(pieces):
            ...
            if idx == 0:
                ...
                for n in range(0, divx):  # generate X dividers
                    ...
                    side(subGroup, (x, y), (d, a), (-b, a), keydivfloor * atabs *
                         # side a
                         (-thickness if a else thickness), dtabs, dx, (1, 0), a, 1, 0, 0)
                ...
                for n in range(0, divy):  # generate Y dividers
                    ...
                    side(subGroup, (x, y), (d, a), (-b, a), keydivwalls * atabs * (-thickness if a else thickness),
                         # side a
                         dtabs, dx, (1, 0), a, 1, divx * yholes, yspacing)
                    side(subGroup, (x + dx, y), (-b, a), (-b, -c), keydivfloor * btabs *
                         # side b
            ...
            if self.options.optimize:
                ...
                for group in groups:
                    ...
                    # closed
                    last_path_element = [child for child in group.descendants(
                    ) if isinstance(child, inkex.PathElement)][0]
                    ...
                    # Last step: If the group now just contains one path,
                    # remove the group around this path
                    if len(group) == 1:
